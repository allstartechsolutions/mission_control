    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-3 rounded-lg border border-gray-200 bg-white p-5 shadow-sm sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <h1 className="mt-2 text-xl font-semibold text-gray-800">Add location</h1>
          <p className="mt-1 text-sm text-gray-500">Create a new site or address for this client.</p>
        </div>
        <Link
      ...
      <LocationForm mode="create" clientId={client.id} clientName={client.companyName} />
    </div>
  );
}
